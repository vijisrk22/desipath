    ...
    *     ),
    ...
    public function store(Request $request)
    {
        ...
        $request->validate([
            ...
            'ad_type' => 'required|string|in:roommate,car,rentalhome,buysellhome,travelcompanion,astrologyad,classesforkid,trainingad,localjob,jobreferral,itjob,financial_advisor,buysellitem',
        ]);
