...
export function getRentalHomeContents(formDetails, images, mode = "post") {
  return [
    ...
    { text: "Available From", value: dayjs(formDetails.available_from || formDetails.fromDate).format("DD-MM-YYYY") },
    { text: "Area", value: `${formDetails.area} m²` },
    { text: "BHK", value: mode === "post" ? formDetails.bedrooms : (formDetails.bhk ? formDetails.bhk.split(" ")[0] : "") },
    { text: "Bathrooms", value: mode === "post" ? formDetails.bathrooms : (formDetails.bhk ? formDetails.bhk.split(" ")[2] : "") },
    ...
    { text: "Amenities", value: mode === "post" ? Object.keys(formDetails.amenities || {}).filter((key) => formDetails.amenities[key]).join(", ") : (Array.isArray(formDetails.amenities) ? formDetails.amenities.join(", ") : formDetails.amenities) },
