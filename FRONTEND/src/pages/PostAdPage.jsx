...
const categories = [
    ...
    { id: 'Lawyer', label: "List my Business - Desi Attorneys", icon: "⚖️", postPath: "/desi-attorneys/post", viewPath: "/profile/myListings", description: "Professional business listing for legal services.", countPath: "/api/attorneys/my-count" },
    ...
    { id: 'Events', label: "List my Event", icon: "🎟️", postPath: "/events/postEvent", viewPath: "/profile/myListings", description: "Promote your events and sell tickets easily.", countPath: "/api/events/my-count" },
