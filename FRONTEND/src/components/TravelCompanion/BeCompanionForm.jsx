...
function BeCompanionForm() {
  ...
  const onSubmit = (data) => {
    if (Object.keys(errors).length === 0) {
      ...
      data.travellers_who = "becomp"; // or any value you need (string/array/etc.)
  ...
  return (
    <div className="px-6 py-4 md:py-6 w-[90%]  relative rounded-tr-2xl rounded-b-2xl bg-white flex flex-col gap-y-4">
      ...
      <div className="max-w-screen-md mx-auto w-full text-gray-600 text-lg font-semibold font-dmsans">
        Post your Travel details and receive message from Travelers who is
        looking for Help
      </div>
      <form
      ...
      >
        ...
        <TwoRadioInput
          ...
          text="Is your schedule confirmed"
          control={control}
        />
        {travelDateConfirmed === "Yes" && (
          <DatePickerInput
            text="If Yes, my travel schedule is"
            control={control}
            toDate={false}
            placeholderLab="Date"
          />
        ...
        {/*Want a gift as Travel Companion  */}
        <ThreeRadioInput
          text="I prefer an Amazon Gift Card/Volunteer for free"
          name="giftCompanion"
          op1="$50"
          op2="$100"
...
export default BeCompanionForm;
